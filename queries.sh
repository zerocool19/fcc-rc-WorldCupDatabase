...
echo "$($PSQL "SELECT game_id, winner_goals + opponent_goals AS total_goals FROM games")"
...
echo "$($PSQL "SELECT game_id, AVG(winner_goals + opponent_goals) AS avg_total_goals FROM games GROUP BY game_id")"
